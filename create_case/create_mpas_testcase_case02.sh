...
clean_before="true"
clean_after="true"
case_base="/lfs5/BMC/wrfruc/Michael.Barlage/mpas/baselines_mpas/create_case/ncar-41e9a3fb8-intelmpi/"
executable="/lfs5/BMC/wrfruc/Michael.Barlage/mpas/testing/code/ncar/intel-mpi/v8.2.2/init_atmosphere_model.41e9a3fb8.intelmpi"
code_base="ncar"
namelist="ncar"
domain="global"
resolution="120km"
