...
#      -  test_repo_name - version_to_compare - compile_flag [e.g., ncar-v8.2.2-intdebug]
#        -  test_repo_name can be whatever short name you want for your repo
#        -  version_to_compare should be the GSL version number, e.g., v8.2.2
...
model_code_base="ncar-restart-v8.3.0-intdebug"
