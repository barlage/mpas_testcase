...
echo "#############################################################################" >> $fileout
echo "# compare to previous GSL CONUS convection_permitting baselines B1           " >> $fileout
echo "#############################################################################" >> $fileout
echo >> $fileout
...
dir2=$gsl_baseline_directory"gsl-$gsl_version_baseline$compile_flag.convection_permitting.ncar.ncar.conus.120km.gfs.2023031015/"
...
echo "######################################################################" >> $fileout
echo "# compare to previous GSL CONUS hrrrv5 GFS baselines C5               " >> $fileout
echo "######################################################################" >> $fileout
echo >> $fileout
...
echo "######################################################################" >> $fileout
echo "# compare to previous GSL CONUS hrrrv5 RAP winter baselines C7        " >> $fileout
echo "######################################################################" >> $fileout
echo >> $fileout
...
echo "######################################################################" >> $fileout
echo "# compare to previous GSL CONUS hrrrv5 RAP summer baselines C8        " >> $fileout
echo "######################################################################" >> $fileout
echo >> $fileout
